...
public class AppointmentResourceIT {
    ...
    @Test
    @Transactional
    public void getAllAppointmentsByUserExtraIsEqualToSomething() throws Exception {
        // Initialize the database
        appointmentRepository.saveAndFlush(appointment);
        ...
        // Get all the appointmentList where userExtra equals to userExtraId
        defaultAppointmentShouldBeFound("userExtraId.equals=" + userExtraId);

        // Get all the appointmentList where userExtra equals to userExtraId + 1
        defaultAppointmentShouldNotBeFound("userExtraId.equals=" + (userExtraId + 1));
    }
