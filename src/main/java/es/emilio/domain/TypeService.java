...
public class TypeService implements Serializable {
    ...
    public TypeService userExtras(Set<UserExtra> userExtras) {
        this.userExtras = userExtras;
        return this;
    }

    public TypeService addUserExtra(UserExtra userExtra) {
        this.userExtras.add(userExtra);
        userExtra.getTypeServices().add(this);
        return this;
    }

    public TypeService removeUserExtra(UserExtra userExtra) {
        this.userExtras.remove(userExtra);
        userExtra.getTypeServices().remove(this);
        return this;
    }
