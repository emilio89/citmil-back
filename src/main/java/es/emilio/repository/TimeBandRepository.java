...
public interface TimeBandRepository extends JpaRepository<TimeBand, Long>, JpaSpecificationExecutor<TimeBand> {
    ...
    @Query(value = "select distinct timeBand from TimeBand timeBand left join fetch timeBand.calendarYearProfesionals",
    ...
    @Query("select distinct timeBand from TimeBand timeBand left join fetch timeBand.calendarYearProfesionals")
    List<TimeBand> findAllWithEagerRelationships();

    @Query("select timeBand from TimeBand timeBand left join fetch timeBand.calendarYearProfesionals where timeBand.id =:id")
