...
/**
 * REST controller for managing {@link es.emilio.domain.UserExtra}.
 */
@RestController
@RequestMapping("/api")
public class UserExtraResource {
    ...
    public ResponseEntity<List<UserExtraDTO>> getAllUserExtras(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
